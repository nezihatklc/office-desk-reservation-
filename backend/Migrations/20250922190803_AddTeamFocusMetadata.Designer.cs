...
namespace backend.Migrations
{
    ...
    [Migration("20250922190803_AddTeamFocusMetadata")]
    partial class AddTeamFocusMetadata
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("backend.Models.Workspace", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            WorkspaceId = 1,
                            Capacity = 7,
                            Created = new DateTime(2025, 9, 22, 19, 8, 2, 987, DateTimeKind.Utc).AddTicks(510),
                            DeskCode = "A",
                            FloorNumber = "1",
                            FocusMode = "Focus",
                            NoiseLevel = 1,
                        ...
                        new
                        {
                            WorkspaceId = 2,
                            Capacity = 7,
                            Created = new DateTime(2025, 9, 22, 19, 8, 2, 987, DateTimeKind.Utc).AddTicks(1480),
                            DeskCode = "B",
                            FloorNumber = "1",
                            FocusMode = "Focus",
                            NoiseLevel = 1,
                        ...
                        new
                        {
                            WorkspaceId = 7,
                            Capacity = 7,
                            Created = new DateTime(2025, 9, 22, 19, 8, 2, 987, DateTimeKind.Utc).AddTicks(1490),
                            DeskCode = "G",
                            FloorNumber = "1",
                            FocusMode = "Collaboration",
                            NoiseLevel = 4,
